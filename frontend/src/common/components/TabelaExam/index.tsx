...
export default function CustomizedTables(props: any) {
  ...
  function deleteRow(id: number) {
    axios.delete(`http://localhost:3333/exam/${id}`);
  }
  useEffect(() => {
  ...
  return (
    <div>
      <TableContainer
        component={Paper}
        sx={{ width: 600, backgroundColor: "#daf3ff" }}
      >
        <Table
          sx={{ width: 600, backgroundColor: "#daf3ff" }}
        ...
        >
          <TableHead sx={{ backgroundColor: "#daf3ff" }}>
            <TableRow sx={{ backgroundColor: "#daf3ff" }}>
              ...
              <StyledTableCell align="right">Tipo de exame</StyledTableCell>
